	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-header">Alterar Cadastro de Administradores</h1>		
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<!-- INÍCIO DO FORM -->
						<form action="alteraadmins2.php" method="post" class="form-group form-group-lg">
							<div class="row">
								<div class="col-md-8">
							...
							<div class="row">
								...
								<div class="col-md-2">
									...
									<select name="nivelAcesso" id="nivel" class="form-control">							
										...
										<option value="1"<?php if($nivel == 1) { echo 'selected'; } ?>>Acesso Total</option>
										<option value="2"<?php if($nivel == 2) { echo 'selected'; } ?>>Acesso Restrito</option>
									</select>
								</div>
							</div>
							<br>
							<div class="row">
								...
								<div class="col-md-3">
									<label for="inputCodi"> Codigo: </label>
									<input type="text" class="form-control" name="cod" id="inputCodi" value="<?php echo $cod ?>" readonly>
								</div>
							</div>
							<br>
							<div class="row">
