...
<body>
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-10">
						<h1 class="page-header"> <br/>Procurar E-mails</h1>
					</div>
				</div>
				<br>

				<!-- INICIO DO FORM -->
				<form action="home.php?pagina=busca_email" method="post" class="form-group form-group-lg">
					<div class="col-md-3">
						<div class="row">
	...
	$dt_final = $_POST['dataFin'];
		...
		include ("conexao.php"); 
			if (!$conexao){
				...
				elseif ($dt_final >= $dt_inicial){
					$procurar_email= "SELECT * FROM tab_email WHERE dt_envio BETWEEN '$dt_inicial' AND '$dt_final'";
					...
					while ($dados = mysqli_fetch_array($resultado)) {
							$mensagem = $dados['mensagem_email'];
							$data = formata_data($dados['dt_envio']);
							$hora = $dados['hr_envio'];
